...
const MarketNftsCards = ({ handleNftClick, description, image, name, owner, price, seller, isCollection }) => (
    <div 
    onClick={() => handleNftClick({description, image, name, owner, price, seller, isCollection})}
...
const DashboardCollected = ({ isLiked, totalLike, bg }) => {
  const { nftsOwned } = useContext(MarketPlaceContext);
  ...
  return (
    <div className="flex w-full justify-center items-center 2xl:px-20">
      <div className="flex flex-col md:p-4 py-4 px-4">
        ...
        <ModalView {...modal}/>
        <NftCardsLayout dummyArtists={nftsOwned}>
...
export default DashboardCollected;